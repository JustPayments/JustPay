Contributing to JUSTPAY Core
============================

The JUSTPAY Core project operates an open contributor model where anyone is
...
The following applies to code changes to the JUSTPAY Core project, and is not to be
confused with overall JUSTPAY Network Protocol consensus changes.

Whether a pull request is merged into JUSTPAY Core rests with the project merge
...
Patches that change JUSTPAY consensus rules are considerably more involved than
...
Where a patch set proposes to change the JUSTPAY consensus, it must have been
...
The project leader is the release manager for each JUSTPAY Core release.
