...
#include "genesis/justpayMainNetwork.cpp"
#include "genesis/justpayTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::justpayMainNetwork: return c_genesisInfoJustPayMainNetwork;
	case Network::justpayTestNetwork: return c_genesisInfoJustPayTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::justpayMainNetwork: return c_genesisStateRootJustPayMainNetwork;
	case Network::justpayTestNetwork: return c_genesisStateRootJustPayTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
