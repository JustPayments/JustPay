...
////////////////////////////////////////////////////////////// // justpay
	void setJustPaySchedule(EVMSchedule _justpaySchedule) const { justpaySchedule = _justpaySchedule; }

	EVMSchedule& getJustPaySchedule() const { return justpaySchedule; }
...
private:
	...
	mutable EVMSchedule justpaySchedule; // justpay
