...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "JUSTPAY server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* JustPay features */
        {"justpay", "masternode", &masternode, true, true, false},
        //{"justpay", "masternodelist", &masternodelist, true, true, false},
        //{"justpay", "mnbudget", &mnbudget, true, true, false},
        //{"justpay", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        //{"justpay", "mnfinalbudget", &mnfinalbudget, true, true, false},
        //{"justpay", "mnsync", &mnsync, true, true, false},
        {"justpay", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        //{"justpay", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use justpayd, or the -server option to justpay-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> justpay-cli " + methodname + " " + args + "\n";
}
