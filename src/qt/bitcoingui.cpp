                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("JUSTPAY Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a JUSTPAY address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and justpay: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About JUSTPAY Core"), this);
    aboutAction->setStatusTip(tr("Show information about JUSTPAY Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for JUSTPAY"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your JUSTPAY addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified JUSTPAY addresses"));
    ...
    openAction->setStatusTip(tr("Open a JUSTPAY: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the JUSTPAY Core help message to get a list with possible JUSTPAY command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("JUSTPAY Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to JUSTPAY network", "", count));
}
...
{
    QString strTitle = tr("JUSTPAY Core"); // default title
