...
#ifndef JUSTPAY_TRADINGDIALOG_H
#define JUSTPAY_TRADINGDIALOG_H
...
private slots:
    ...
    void showBalanceOfJUSTPAYOnTradingTab();
    ...
    void showBalanceOfJUSTPAYOnSendTab();
    void showBalanceOfJUSTPAYOnBalanceTab();
    ...
    QString BuyJUSTPAY(QString OrderType, double Quantity, double Rate);
    QString SellJUSTPAY(QString OrderType, double Quantity, double Rate);
    ...
    QString sendRequest(QString url, QString method = "GET", QString body = QString("{\"market\":\"JUSTPAY/BTC\"}"));// "{\"gender\":\"male\"}");
    void sendRequest1(QString url, std::function<void (void)> funcForCallAfterReceiveResponse, QString method = "GET", QString body = QString("{\"market\":\"JUSTPAY/BTC\"}"));// "{\"gender\":\"male\"}");
