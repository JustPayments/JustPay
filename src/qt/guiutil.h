...
/** Utility functions used by the JUSTPAY Qt UI.
 */
namespace GUIUtil
{
...
// Render JUSTPAY addresses in monospace font
...
// Parse "justpay:" URI into recipient object, return true on successful parsing
