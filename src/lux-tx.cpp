...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("JustPay Core justpay-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  justpay-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded justpay transaction") + "\n" +
                               "  justpay-tx [options] -create [commands]   " + _("Create hex-encoded justpay transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded justpay transaction
