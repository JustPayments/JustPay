...
This mechanism has been integrated into Bitcore-Node-JUSTPAY which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/JUSTPAY-Project/insight-api-justpay#web-socket-api](https://github.com/JUSTPAY-Project/insight-api-justpay#web-socket-api) 
* API: [https://github.com/JUSTPAY-Project/insight-api-justpay#swifttx-transactions](https://github.com/JUSTPAY-Project/insight-api-justpay#swifttx-transactions) 
...
By default, the JUSTPAY Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the JUSTPAY Core daemon:
