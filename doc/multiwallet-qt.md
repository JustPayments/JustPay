...
In order to support loading of multiple wallets in justpay-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is justpay.cpp.
...
Changes to justpay.cpp
----------------------
justpay.cpp is the entry point into justpay-qt, and as such, will require some minor modifications to provide hooks for
