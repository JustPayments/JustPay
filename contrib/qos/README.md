...
This means one can have an always-on justpayd instance running, and another local justpayd/justpay-qt instance which connects to this node and receives blocks from it.
