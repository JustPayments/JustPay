...
RESOURCES += src/qt/justpay.qrc src/qt/justpay_locale.qrc

TRANSLATIONS += src/qt/locale/justpay_bg.ts \
                src/qt/locale/justpay_de.ts \
                src/qt/locale/justpay_en.ts \
                src/qt/locale/justpay_es.ts \
                src/qt/locale/justpay_fi.ts \
                src/qt/locale/justpay_fr.ts \
                src/qt/locale/justpay_it.ts \
                src/qt/locale/justpay_ja.ts \
                src/qt/locale/justpay_pl.ts \
                src/qt/locale/justpay_pt.ts \
                src/qt/locale/justpay_ru.ts \
                src/qt/locale/justpay_sk.ts \
                src/qt/locale/justpay_sv.ts \
                src/qt/locale/justpay_vi.ts \
                src/qt/locale/justpay_zh_CN.ts \
                src/qt/locale/justpay_zh_TW.ts
